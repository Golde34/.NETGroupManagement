...
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,1,1)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,1,1)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,1,2)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,1,2)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,1,3)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,1,3)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,1,4)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',DateAdd(DD,-7,GETDATE() ),GETDATE(),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,1,4)
