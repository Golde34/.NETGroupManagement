...
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,2,2)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,2,2)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,3,3)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,3,3)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 1',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is an error about NullPointerException at line 1311 at Controller x', 'Should be fixed in 7 days after release issues',1,1,2,4,4)
INSERT INTO Issues(title,dueDate,startDate,description,content,state,creator,assignee,projectId,status) VALUES ('Exception 2',GETDATE(), DateAdd(DD,-7,GETDATE() ),'There is 2 errors about ArithmethicException at line 2001 at Controller y', 'Should be fixed in 7 days after release issues',1,1,2,4,4)
